...
export const SellCarPage = () => {
    ...
    return (
        <div style={{ width: "80%", maxWidth: "1400px", margin: "0 auto", height: "60vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "24px", color: "var(--text-primary)" }}>
