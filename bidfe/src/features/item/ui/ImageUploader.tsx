    ...
    return (
        <div className="image-uploader-wrapper">
            <style>{`
                ...
                /* --- CHANGED: Full Width Vertical Stack --- */
                .gallery-grid {
                    display: flex;       /* Changed from grid to flex column */
                    flex-direction: column;
                    gap: 24px;           /* More breathing room between big images */
                    width: 100%;
                }
                ...
                .gallery-item {
                    ...
                    background: #e2e8f0;
                    width: 100%;
                    aspect-ratio: 16/9; /* Enforce landscape ratio even for full width */
                }
                ...
                .delete-btn {
                    /* Always visible now since images are huge */
                    opacity: 1; 
                    transform: scale(1);
                    transition: all 0.2s ease;
                }
                .gallery-item:hover .delete-btn {
                    background-color: #ef4444; /* Turn red on hover */
                    color: white;
                }
                
                /* Mini upload bar at the bottom */
                .mini-upload-bar {
                    display: flex;
                    align-items: center;
            ...
            <div className="gallery-grid" style={{ marginBottom: hasImages ? "24px" : "0" }}>
                ...
                {existingImages.map((img, index) => (
                    <div key={img.id} className="gallery-item">
                        <img src={img.thumbnailUrl} alt="Vehicle" className="gallery-img" />
...
const styles = {
    ...
    title: {
        fontSize: "16px", fontWeight: 700, color: "#1e293b", marginRight: "12px"
    },
    counter: {
        fontSize: "13px", fontWeight: 500, color: "#64748b", backgroundColor: "#f1f5f9", padding: "2px 10px", borderRadius: "12px"
    },

    bigDropZone: {
        display: "flex", flexDirection: "column" as const, alignItems: "center", justifyContent: "center",
        gap: "16px", padding: "40px", borderRadius: "16px", cursor: "pointer",
    },

    iconCircle: {
        width: "56px", height: "56px", borderRadius: "50%", backgroundColor: "#fff",
        boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05)", display: "flex", alignItems: "center", justifyContent: "center",
        color: "#3b82f6"
    },
    ...
    mainBadge: {
        ...
        color: "#fff", fontSize: "12px", fontWeight: 700, padding: "8px 12px", borderRadius: "20px",
        display: "flex", alignItems: "center", gap: "6px", pointerEvents: "none" as const,
